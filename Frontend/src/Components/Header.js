        ...
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <nav className="md:ml-auto flex flex-wrap items-center font-serif text-base justify-center">
            <div className="flex justify-center">
              <Link to="/categories" className="bg-yellow-500 text-white px-4 py-2 rounded mr-2">Categories</Link>
              <Link to="/contactUs" className="bg-purple-500 text-white px-4 py-2 rounded mr-2">Contact Us</Link>
            </div>
            <div className="flex justify-center">
              <Link to="/listings" className="bg-blue-500 text-white px-4 py-2 rounded mr-2">View Listings</Link>
              <Link to="/sell-your-car" className="bg-green-500 text-white px-4 py-2 rounded">Sell Your Car</Link>
            </div>
          </nav>
        </div>
      </header>
